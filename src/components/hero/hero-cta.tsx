  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <a
        ...
        className="inline-flex items-center justify-center gap-2 border border-gd-border text-gd-text-primary rounded-lg px-6 py-3 font-medium hover:bg-gd-bg-hover transition"
      >
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
